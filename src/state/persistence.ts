...
// Bumped to v9: RaceState gained the required settings field — an old save's missing
// field would be undefined, and every settings.xEnabled check in simulateLap would throw.
const SAVE_KEY = "f1-manager-save-v9";
